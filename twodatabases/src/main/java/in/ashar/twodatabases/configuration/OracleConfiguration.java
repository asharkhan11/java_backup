package in.ashar.twodatabases.configuration;
...
@EnableJpaRepositories(
        ...
        basePackages = "in.ashar.twodatabases.repositories.oracle"
)
public class OracleConfiguration {
    ...
    @Bean
    public LocalContainerEntityManagerFactoryBean oracleEntityManager(@Qualifier("oracleDataSource") DataSource dataSource, @Qualifier("oracleJpaVendorAdapter") JpaVendorAdapter jpaVendorAdapter){

        LocalContainerEntityManagerFactoryBean localContainerEntityManagerFactoryBean = new LocalContainerEntityManagerFactoryBean();
        localContainerEntityManagerFactoryBean.setDataSource(dataSource);
        localContainerEntityManagerFactoryBean.setJpaVendorAdapter(jpaVendorAdapter);
        localContainerEntityManagerFactoryBean.setPackagesToScan("in.ashar.twodatabases.entities.oracle");
